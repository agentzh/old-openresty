...
--- request
GET /=/model/Foo/~/~?_order_by=name:desc
--- response
[
    {"name":"Marry","id":"1","age":"21"},
    {"name":"Larry","id":"6","age":"59"},
...
--- request
GET /=/model/Foo/~/~?_order_by=age:desc
--- response
[
    {"name":"Larry","id":"6","age":"59"},
    {"name":"Bob","id":"2","age":"32"},
...
--- request
GET /=/model/Foo/~/~?_order_by=name:asc,age:desc
--- response
[
    {"name":"Audrey","id":"7","age":"17"},
    {"name":"Bob","id":"2","age":"32"},
...
--- request
GET /=/model/Foo/~/~?_order_by=name,age:desc
--- response
[
    {"name":"Audrey","id":"7","age":"17"},
    {"name":"Bob","id":"2","age":"32"},
...
--- request
GET /=/model/Foo/~/~?_order_by=name,age:desc,id
--- response
[
    {"name":"Audrey","id":"7","age":"17"},
    {"name":"Bob","id":"2","age":"32"},
...
--- request
GET /=/model/Foo/name/Bob?_order_by=age
--- response
[
    {"name":"Bob","id":"3","age":"15"},
    {"name":"Bob","id":"2","age":"32"}
...
--- request
GET /=/model/Foo/name/Bob?_order_by=age:desc
--- response
[
    {"name":"Bob","id":"2","age":"32"},
    {"name":"Bob","id":"3","age":"15"}
...
--- request
GET /=/model/Foo/name/Bob?_order_by=
--- response
...
--- request
GET /=/model/Foo/name/Bob?_order_by=name:blah
--- response
...
--- request
GET /=/model/Foo/name/Bob?_order_by=name:blah:foo
--- response
...
--- request
GET /=/model/Foo/~/~?_order_by=name:blah:foo
--- response
{"success":0,"error":"Invalid order_by direction: blah:foo"}
