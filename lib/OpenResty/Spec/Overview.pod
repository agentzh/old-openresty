...
Not every view can be used to drive the feed generation. The resulting rows of the view must have the columns that make sense to the feed, like C<author>, C<title>, C<link>, C<content>, C<published>, and C<comments>.
