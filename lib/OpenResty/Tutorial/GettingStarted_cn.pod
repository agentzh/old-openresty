...
请在来信中附上你希望的帐户名（全部小写字母加数字）以及 Admin 角色的初始密码。一般来说，我们创建的帐户都位于下面这个服务器：C<resty.eeeeworks.org>.
...
L<http://10.62.164.49/wiki/index.php?title=REST_cn#Models>

以及

L<http://search.cpan.org/perldoc?OpenResty::Spec::Overview#Models>
...
L<http://10.62.164.49/wiki/index.php?title=REST_cn#Views>

以及

L<http://search.cpan.org/perldoc?OpenResty::Spec::Overview#Views>
