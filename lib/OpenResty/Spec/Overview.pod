...
The OpenResty server opens a special door to JavaScript code in a web
page coming from the user's own domain, so as to allow REST requests get
directly initiated from I<end> users' web browsers.
