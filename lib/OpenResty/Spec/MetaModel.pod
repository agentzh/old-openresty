...
This document describes the 0.003 version of the metamodel used in the
OpenResty 0.2.0.
...
Note that, as of OpenResty 0.2.x, the _action table has not been included in the MetaModel implementation yet.
